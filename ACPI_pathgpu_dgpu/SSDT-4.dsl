 ...
 *
 * Disassembly of SSDT-4.aml, Sun Oct 28 15:24:11 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003882 (14466)
 *     Revision         0x01
 *     Checksum         0xF2
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "SSDT", 1, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    Scope (\_SB.PCI0.RP05.PXSX)
    {
        ...
        Method (GC6I, 0, Serialized)
        {
            ...
            Sleep (0x0A)
            Store (One, \_SB.PCI0.RP05.LNKD)
            While (LNotEqual (\_SB.PCI0.RP05.PRGC, One))
            {
                H2OP (0xAB)
                Sleep (One)
            }
        ...
        {
            If (LNotEqual (\_SB.PCI0.RP05.PRGC, One))
            {
                H2OP (0xAD)
                Return (One)
            }
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x05)
                {
                    ...
                    ElseIf (ToInteger (DMSK))
                    {
                        ...
                        Store (\_SB.PCI0.RP05.PXSX.NTOI, TLSN)
                        Store (One, DPAE)
                    }
