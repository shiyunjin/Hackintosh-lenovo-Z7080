 ...
 *
 * Disassembly of DSDT.aml, Sun Oct 28 15:24:11 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000FE43 (65091)
 *     Revision         0x02
 *     Checksum         0xBC
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
            ...
            Scope (\_SB.PCI0.LPCB.EC0)
            {
                Device (VPC0)
                {
                    ...
                    Method (SMTF, 1, NotSerialized)
                    {
                        If (LEqual (Arg0, Zero))
                        {
                            If (LEqual (B1B2(FV00,FV01), Zero))
                            {
                                Return (Zero)
                            }

                            If (LEqual (B1B2(AC00,AC01), Zero))
                            {
                                Return (Zero)
                            }
                            ...
                            {
                                Store (B1B2(FV00,FV01), VBPV)
                                Store (B1B2(AC00,AC01), VBAC)
